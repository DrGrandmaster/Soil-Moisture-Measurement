...
def readPH(pHtimer):
    voltage = (phRead.read_u16() * factorADC * factorPH)
    print(0.5*(voltage-1.1) + 7.0) #The numbers are temporary
...
###
def webpage(temperature): #ignore
    #Template HTML
    html = f"""
            <!DOCTYPE html>
            <html>
